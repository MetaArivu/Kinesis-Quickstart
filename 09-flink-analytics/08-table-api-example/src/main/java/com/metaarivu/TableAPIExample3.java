...
public class TableAPIExample3 {

	public static void main(String[] args) throws Exception {

		System.out.println("Starting Table API Examples3 ==>");
		...
		Table resultTable = tableEnv.sqlQuery("SELECT sector as sector, min(price) as minprice, max(price) as maxprice FROM stockTable GROUP BY sector");
